"""Tests for Bluesky post extraction and transformation.

Tests the post_to_item() and extract_text_from_facets() functions
that transform AT Protocol data into ItemCreate objects.
"""
...
class TestFacetsExtraction:
    ...
    def test_extracts_mentions_from_facets(self, bluesky_post_factory):
        ...
        # Mock mention facets
        mention1 = SimpleNamespace(did="did:plc:alice123")
        mention1.__class__.__name__ = "Mention"

        mention2 = SimpleNamespace(did="did:plc:bob456")
        mention2.__class__.__name__ = "Mention"
    ...
    def test_extracts_links_from_facets(self, bluesky_post_factory):
        ...
        link = SimpleNamespace(uri="https://example.com")
        link.__class__.__name__ = "Link"
    ...
    def test_extracts_hashtags_from_facets(self, bluesky_post_factory):
        ...
        tag = SimpleNamespace(tag="test")
        tag.__class__.__name__ = "Tag"
...
class TestEmbeds:
    ...
    def test_embed_images_stores_alt_and_aspect_ratio(
        ...
        assert item.metadata["embed_type"] == "Main"
...
class TestExtractTextFromFacets:
    ...
    def test_extracts_multiple_facet_types(self):
        ...
        mention = SimpleNamespace(did="did:plc:user123")
        mention.__class__.__name__ = "Mention"

        link = SimpleNamespace(uri="https://example.com")
        link.__class__.__name__ = "Link"

        tag = SimpleNamespace(tag="python")
        tag.__class__.__name__ = "Tag"
