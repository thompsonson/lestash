"""Tests for items display logic (get_author_actor, get_preview)."""
...
class TestGetPreview:
    ...
    def test_truncates_long_content(self, test_db):
        ...
        with get_connection(test_db) as conn:
            preview = get_preview(conn, item, max_length=50)
